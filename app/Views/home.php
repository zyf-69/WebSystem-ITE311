    ...
    <div class="col-12">
        <div class="jumbotron bg-light p-5 rounded">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                <a class="btn btn-primary btn-lg" href="<?= base_url('register') ?>" role="button">Get Started</a>
                <a class="btn btn-outline-secondary btn-lg" href="<?= base_url('login') ?>" role="button">Login</a>
            </div>
        </div>
    </div>
</div>
